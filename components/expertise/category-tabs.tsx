			...
			{categories.map((cat) => {
				...
				return (
					<button
						...
						className={`${sora.className} group relative flex cursor-pointer items-center justify-between rounded-2xl border border-transparent bg-slate-50 px-5 py-4 text-left transition-all duration-200 hover:-translate-y-1 hover:border-blue-400/40 hover:bg-white dark:bg-slate-900/40 dark:hover:border-blue-500/50 dark:hover:bg-slate-900/70 ${isActive ? "border-blue-500/60 bg-white shadow-lg shadow-blue-500/10 dark:bg-slate-900" : ""} text-slate-900 dark:text-slate-100`}
					>
