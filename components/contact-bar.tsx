...
export default function ContactBar() {
  ...
  const iconSize = screenSize < 768 ? 40 : 30;
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full bg-transparent p-8 flex items-center justify-between" style={{ color: isDark ? 'white' : '#0f172a', boxShadow: isDark ? '0 4px 6px -1px rgba(0, 0, 0, 0.1)' : 'none' }}>
